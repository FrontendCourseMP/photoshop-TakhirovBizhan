...
export const GAMMA_RANGE: LevelsRange = {
  ...
  // малые значения затемняют midtones, большие осветляют.
  min: 0.1,
  max: 9.9,
  // Шаг 0.01 совпадает с точностью, которую дает перетаскивание полутонового маркера,
  // поэтому ручной ввод и маркер работают с одной и той же сеткой значений.
  step: 0.01,
}
